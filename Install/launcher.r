...
source("./Source/Intermediate_project/1.matrix_full.r")

source("./Source/Intermediate_project/2.climate.r")

source("./Source/Intermediate_project/3.ecosystems.r")

source("./Source/Intermediate_project/4.elevation.r")

source("./Source/Intermediate_project/5.sat_manual.r")
